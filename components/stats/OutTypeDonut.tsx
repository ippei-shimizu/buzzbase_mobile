import type { OutTypeBreakdownCategory } from "../../types/stats";
import React from "react";
import { View, Text, StyleSheet } from "react-native";
import Svg, { Circle, Text as SvgText } from "react-native-svg";

interface OutTypeDonutProps {
...
export const OutTypeDonut = ({ breakdown, total }: OutTypeDonutProps) => {
  if (total === 0) {
    return (
      <View style={styles.container}>
        <Text style={styles.title}>打球の種類</Text>
