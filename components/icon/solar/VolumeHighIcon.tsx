...
// 出典: Solar Icons (volume-loud-bold) by 480 Design / CC BY 4.0
  ...
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    <G fill={color}>
      ...
      <Path
        ...
        clipRule="evenodd"
      />
      <Path d="M20.505 12c0-2.008-.358-3.417-.7-4.306a6 6 0 0 0-.46-.961q-.09-.15-.136-.211l-.03-.041l-.046-.062a.75.75 0 0 1 1.198-.9l-.494.413c.494-.412.495-.412.495-.411l.005.005l.007.01l.021.027l.065.086q.08.11.203.312c.162.27.368.666.572 1.195c.408 1.062.8 2.653.8 4.844s-.392 3.783-.8 4.844a7.7 7.7 0 0 1-.572 1.195a5 5 0 0 1-.268.399l-.021.026l-.007.01l-.005.005l-.577-.479l.576.48a.75.75 0 0 1-1.198-.899l.042-.055v-.003l.003-.001v-.002l.031-.041q.046-.063.137-.211c.12-.2.288-.517.459-.962c.341-.889.7-2.298.7-4.306" />
    </G>
  </Svg>
);
