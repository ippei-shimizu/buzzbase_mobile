...
const BATTING_STATS: StatDef[] = [
  ...
  {
    name: "得点圏打率",
    formula: "得点圏での安打 ÷ 得点圏での打数",
    description:
      "二塁または三塁に走者がいる場面（得点圏。一・二塁や満塁も含みます）での打率で、チャンスでの勝負強さを示します。走者状況を記録した打席が対象で、得点圏での打数が 0 のときは「-」と表示します。",
  },
  {
    name: "ISO",
...
const PITCHING_STATS: StatDef[] = [
  {
    name: "防御率",
    formula: "自責点×イニング制 ÷ 投球回数",
    description:
      "その投手が1試合を投げたとしたら何点に抑えられるかを示す指標です。試合のイニング制（7回制 or 9回制）に応じて係数が変わります。",
  },
  {
    name: "勝利",
    description:
  ...
  {
    name: "K/9",
    formula: "（奪三振数×イニング制）÷（投球回数）",
    description:
      "1試合で三振をいくつ奪えるかを表した指標です。試合のイニング制（7回制 or 9回制）に応じて係数が変わります。",
  },
  {
    name: "BB/9",
